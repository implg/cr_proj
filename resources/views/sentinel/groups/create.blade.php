...
<div class="row">
    <form method="POST" action="{{ route('sentinel.groups.store') }}" accept-charset="UTF-8">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="form-group {{ ($errors->has('name')) ? 'has-error' : '' }}">
                            <input class="form-control" placeholder="Название" name="name" type="text"  value="{{ Request::old('email') }}">
        ...
        <input class="btn btn-success" value="Create New Group" type="submit">
